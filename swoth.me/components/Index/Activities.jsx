        ...
        <div className="pt-5 pb-10 md:grid grid-cols-3 gap-x-6">
            ...
            <div className="mt-5 md:mt-0 rounded-lg overflow-hidden col-span-2 w-full h-[140px] sm:gap-x-6 py-5 relative">
                ...
                {profile && <div className="z-1 absolute inset-0">
                    <iframe src="https://linkcord.js.org/api/v3/widget/956417866104713256?type=spotify_large&lang=en&theme=dark&align=left&background=080808" className="w-full" height="140" allowtransparency="true" frameBorder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts" />
                </div>}
            </div>
        </div>
    );
